...
public final class ValveQteHud {
    ...
    public static void render(GuiGraphics guiGraphics, float partialTick) {
        if (!ValveQteClient.isHudVisible()) {
            return;
        }
        ...
        boolean expectRight = ValveQteClient.isExpectRight();
        ...
        int failTicks = ValveQteClient.getFailFlashTicks();
        int failedButton = ValveQteClient.getFailedButton();
        int successTicks = ValveQteClient.getSuccessFlashTicks();
